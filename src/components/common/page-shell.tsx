...
export function PageShell({
  ...
  return (
    <div className={cn('dp-mesh-page-bg min-h-[100dvh] h-[100dvh] overflow-hidden', className)}>
      ...
      <ScrollArea
        className={cn(
          'relative mx-auto flex h-[calc(100dvh-5.5rem)] w-full flex-col gap-5 px-4 pb-24 pt-2 sm:h-[calc(100dvh-6rem)] sm:px-6 sm:pt-3 lg:h-[calc(100dvh-6.5rem)] lg:pt-4',
