...
import { DoraStageModel } from '@/app/analyse/_components/stage/dora-stage-model'
import { AnalysisStageCanvasFallback } from '@/app/analyse/_components/stage/analysis-stage-canvas-fallback'
import { SceneLights } from '@/app/analyse/_components/stage/scene-lights'
import type { WebGLRenderer } from 'three'

const STAGE_TARGET_Y = 0.04
const STAGE_MODEL_FLOOR_Y = -1.05
  ...
  return (
    <div className="absolute inset-0 z-0 opacity-85">
      ...
      >
        ...
        <DoraStageModel />
        <ContactShadows
          position={[0, STAGE_MODEL_FLOOR_Y, 0]}
          opacity={0.32}
          scale={8.8}
          blur={2.6}
          far={4}
