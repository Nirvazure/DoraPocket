...
import { StageVoiceFab } from '@/app/analyse/_components/stage/stage-voice-fab'
import { AnalysisStageStatus } from '@/app/analyse/_components/stage/analysis-stage-status'
import { AnalysisStageCanvasFallback } from '@/app/analyse/_components/stage/analysis-stage-canvas-fallback'

const AnalysisStageCanvas = dynamic(
  () =>
    import('@/app/analyse/_components/stage/analysis-stage-canvas').then(
      (module) => module.AnalysisStageCanvas,
    ),
  {
    ssr: false,
    ...
    >
      ...
      >
        ...
        <div className="pointer-events-auto absolute inset-x-0 top-0 z-20 px-4 py-2.5">
          <AnalysisStageStatus appState={appState} analysisFlow={analysisFlow} />
        </div>
